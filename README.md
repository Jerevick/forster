...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create forster-2645
  fly apps create forster-2645-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app forster-2645
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app forster-2645-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'forster-2645-staging' does not match app name in config file 'forster-2645'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name forster-2645-db
  fly postgres attach --app forster-2645 forster-2645-db

  fly postgres create --name forster-2645-staging-db
  fly postgres attach --app forster-2645-staging forster-2645-staging-db
  ```
